...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    referenceImage: '/templates/tpl-salon-open.jpg',
  ...
  },
  {
    ...
    referenceImage: '/templates/tpl-esthe-campaign.jpg',
  ...
  },
  {
    ...
    referenceImage: '/templates/tpl-takeout-menu.jpg',
  ...
  },
  {
    ...
    referenceImage: '/templates/tpl-bento-menu.jpg',
  ...
  },
  {
    ...
    referenceImage: '/templates/tpl-line-friend-guide.jpg',
    productionTags: ['LINE登録促進'],
    designTags: ['シンプル', 'かわいい', 'お任せ'],
  },

  // ══ 新規テンプレ11種（2026-08-20 追加・飲食／db-food-*）══
  {
    id: 'db-food-vertical-hero',
    name: '縦書き商品ヒーロー',
    description: '巨大な縦書き商品名と料理写真で、一品を強く印象づける和モダン告知。',
    sampleUses: '新メニュー・ランチ限定商品・おすすめ料理',
    layoutType: 'product-card',
    bgFrom: '#0f3d5c', bgTo: '#1a5c7a',
    referenceImage: '/templates/tpl-db-food-vertical-hero.jpg',
    productionTags: ['新商品告知', '商品ヒーロー訴求', '季節限定メニュー'],
    designTags: ['インパクト', 'SNS映え', 'お任せ'],
  },
  {
    id: 'db-food-takeout-dense',
    name: '情報充実テイクアウトメニュー',
    description: '主力商品・味・トッピング・注文方法まで1枚に整理する情報量の多いメニュー。',
    sampleUses: '餃子持ち帰り・たこ焼きメニュー・惣菜テイクアウト',
    layoutType: 'menu-list',
    bgFrom: '#5b3a7a', bgTo: '#8a5cae',
    referenceImage: '/templates/tpl-db-food-takeout-dense.jpg',
    productionTags: ['お持ち帰りメニュー表', 'グランドメニュー表'],
    designTags: ['インパクト', 'ナチュラル', 'お任せ'],
  },
  {
    id: 'db-food-four-grid',
    name: '4商品フォトグリッド',
    description: '4枚の料理写真と中央の価格訴求で、選べるメニューを直感的に見せる。',
    sampleUses: 'ランチ4種・丼メニュー・デザート4種',
    layoutType: 'menu-list',
    bgFrom: '#c8b6e2', bgTo: '#a7d7c5',
    referenceImage: '/templates/tpl-db-food-four-grid.jpg',
    productionTags: ['グランドメニュー表', 'SNS投稿画像', '季節限定メニュー'],
    designTags: ['SNS映え', 'かわいい', 'シンプル', 'お任せ'],
  },
  {
    id: 'db-food-list-menu',
    name: '写真付き縦型メニュー一覧',
    description: '主役写真と商品一覧を整然と配置する、価格比較しやすい縦型メニュー。',
    sampleUses: '串焼きメニュー・小皿料理・お持ち帰り一覧',
    layoutType: 'menu-list',
    bgFrom: '#1f2d5c', bgTo: '#3d4d7a',
    referenceImage: '/templates/tpl-db-food-list-menu.jpg',
    productionTags: ['グランドメニュー表', 'お持ち帰りメニュー表'],
    designTags: ['シンプル', '高級感', 'お任せ'],
  },
  {
    id: 'db-food-editorial-brunch',
    name: 'エディトリアル3品メニュー',
    description: '余白を生かし、3品と追加メニューを上品に紹介するカフェ向けデザイン。',
    sampleUses: 'ブランチ・コース紹介・カフェランチ',
    layoutType: 'menu-list',
    bgFrom: '#9caf88', bgTo: '#c9c3d8',
    referenceImage: '/templates/tpl-db-food-editorial-brunch.jpg',
    productionTags: ['グランドメニュー表', 'メニュー表紙・ブランド紹介'],
    designTags: ['シンプル', '高級感', 'ナチュラル', 'お任せ'],
  },
  {
    id: 'db-food-price-impact',
    name: '超大型価格キャンペーン',
    description: '巨大な価格と3商品の写真で、開店・周年・期間限定キャンペーンを強く訴求。',
    sampleUses: 'OPEN記念・周年祭・期間限定均一価格',
    layoutType: 'color-text',
    bgFrom: '#2563eb', bgTo: '#7c3aed',
    referenceImage: '/templates/tpl-db-food-price-impact.jpg',
    productionTags: ['キャンペーン・セール告知', '新規オープン告知', 'クーポン告知'],
    designTags: ['インパクト', 'お任せ'],
  },
  {
    id: 'db-food-opening-event',
    name: 'イラスト付きオープニングイベント',
    description: '商品イラスト・特典カード・アクセス情報をまとめる親しみやすい開店告知。',
    sampleUses: 'ベーカリー開店・菓子店イベント・カフェ周年イベント',
    layoutType: 'color-text',
    bgFrom: '#b8a4d4', bgTo: '#f4b6c2',
    referenceImage: '/templates/tpl-db-food-opening-event.jpg',
    productionTags: ['新規オープン告知', 'イベント告知'],
    designTags: ['かわいい', 'ナチュラル', 'お任せ'],
  },
  {
    id: 'db-food-luxury-product',
    name: '高級スイーツ・プロダクトヒーロー',
    description: '単色背景・大型英字・中央の商品写真で高級感を出す新商品告知。',
    sampleUses: '季節限定クレープ・パフェ・高級デザート',
    layoutType: 'product-card',
    bgFrom: '#1a2340', bgTo: '#3d2b4a',
    referenceImage: '/templates/tpl-db-food-luxury-product.jpg',
    productionTags: ['新商品告知', '商品ヒーロー訴求', '季節限定メニュー'],
    designTags: ['高級感', 'インパクト', 'SNS映え', 'お任せ'],
  },
  {
    id: 'db-food-seasonal-shaved-ice',
    name: '季節の和スイーツ',
    description: '大きな和文タイトルと中央の商品写真、和柄で季節商品を上品に見せる。',
    sampleUses: 'かき氷・和パフェ・季節の甘味',
    layoutType: 'product-card',
    bgFrom: '#b8a0d4', bgTo: '#e2a0b8',
    referenceImage: '/templates/tpl-db-food-seasonal-shaved-ice.jpg',
    productionTags: ['季節限定メニュー', '新商品告知', '商品ヒーロー訴求'],
    designTags: ['高級感', 'お任せ'],
  },
  {
    id: 'db-food-ingredient-anatomy',
    name: '具材解説サンドイッチ',
    description: '大きな断面写真と引き出し線で、商品の素材やこだわりを説明する。',
    sampleUses: 'サンドイッチ・ハンバーガー・パフェの構成紹介',
    layoutType: 'photo-overlay',
    bgFrom: '#3d5a80', bgTo: '#5c8aae',
    referenceImage: '/templates/tpl-db-food-ingredient-anatomy.jpg',
    productionTags: ['商品ヒーロー訴求', 'SNS投稿画像'],
    designTags: ['シンプル', 'インパクト', 'お任せ'],
  },
  {
    id: 'db-food-oversized-photo-type',
    name: '写真全面＋超大型タイポグラフィ',
    description: '料理写真全面に巨大な店名・商品名を重ね、ブランド感を強く出す。',
    sampleUses: 'サンドイッチ店紹介・看板商品・店舗ブランド投稿',
    layoutType: 'photo-overlay',
    bgFrom: '#1c1c1c', bgTo: '#2d3d3d',
    referenceImage: '/templates/tpl-db-food-oversized-photo-type.jpg',
...
const MATERIAL_UPLOAD: Record<string, { label: string; hint: string; needed?: boolean }> = {
  ...
  // ── 新規テンプレ11種（db-food-*）──
  'db-food-vertical-hero':      { label: '料理写真アップロード（推奨・1点）', hint: '主役料理が1品で全体が見える写真' },
  'db-food-takeout-dense':      { label: '商品写真アップロード（推奨）', hint: '主力商品の写真があれば添付（複数可）' },
  'db-food-four-grid':          { label: '商品写真アップロード（推奨・4点）', hint: '4商品それぞれの写真を添付してください' },
  'db-food-list-menu':          { label: '主役写真・商品写真アップロード（推奨）', hint: '上部の主役写真と、各商品の写真があれば添付' },
  'db-food-editorial-brunch':   { label: '3品の写真アップロード（推奨）', hint: 'メイン3品の写真を添付してください' },
  'db-food-price-impact':       { label: '対象商品の写真アップロード（推奨・3点）', hint: 'キャンペーン対象3商品の写真' },
  'db-food-opening-event':      { label: '商品写真・イラスト用写真（任意）', hint: '商品写真があれば添付。なければ装飾イラストで制作' },
  'db-food-luxury-product':     { label: '商品写真アップロード（推奨・1点）', hint: '背景が整理された単品写真' },
