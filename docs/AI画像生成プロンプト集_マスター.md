...
```
[画像入力1: 参考デザイン画像(スパ&マッサージOPEN告知)]
[画像入力2: 顧客写真(メイン施術写真)]
[画像入力3: 予約QRコード(使用する場合のみ)]

Image 1のレイアウト・配色・装飾・フォントの雰囲気を完全に踏襲したまま、新しいプロモーション画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(焼肉弁当メニュー)]
[画像入力2〜8: 顧客写真(下記7箇所にそれぞれ対応)]
[画像入力9: 注文QRコード]

Image 1の黒背景・金と赤を基調にした和風高級感のある配色とレイアウトを完全に踏襲したまま、新しいメニュー画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(テイクアウト弁当メニュー)]
[画像入力2〜10: 顧客写真(下記9箇所にそれぞれ対応)]
[画像入力11: 注文QRコード]

Image 1のナチュラル・ベージュ系の配色、上部写真タイル＋大見出し＋商品グリッドというレイアウトを完全に踏襲したまま、新しいメニュー画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(エステ集客・ピンク)]
[画像入力2: 顧客写真(メイン施術写真)]
[画像入力3: 顧客写真(キャンペーン欄の小写真)]
[画像入力4: サロン内観写真]
[画像入力5: LINE公式アカウントQRコード]

Image 1のピンク×ゴールドの配色、花の装飾、レイアウトを完全に踏襲したまま、新しい集客画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(エステ集客・ゴールド)]
[画像入力2: 顧客写真(メイン施術写真)]
[画像入力3: 顧客写真(キャンペーン欄の小写真)]
[画像入力4: コースA写真]
[画像入力5: コースB写真]
[画像入力6: コースC写真]
[画像入力7: LINE公式アカウントQRコード]

Image 1の白×ゴールド×ベージュの上品な配色、レイアウト構成を完全に踏襲したまま、新しい集客画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(LINE公式アカウント案内)]
[画像入力2: 顧客のQRコード画像]

Image 1の緑を基調にした配色、上部LINEロゴ帯、2ステップ説明、下部のイラスト帯という構成を完全に踏襲したまま、新しい案内画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(ラーメン店メインチラシ)]
[画像入力2〜6: 顧客写真(下記5箇所にそれぞれ対応)]
[画像入力7: LINEクーポンQRコード]

Image 1のレイアウト・配色・装飾・フォントの雰囲気を完全に踏襲したまま、新しいチラシ画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(LINE友だち追加特典)]
[画像入力2: 顧客のQRコード画像]

Image 1の緑を基調にした配色、スマホイラスト、3つの特典ボックス、3ステップ登録案内、下部のキャラクターイラストという構成を完全に踏襲したまま、新しい案内画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(手描き風・料理写真+吹き出しコメント)]
[画像入力2: 顧客の料理写真]
...
```
[画像入力1: 参考デザイン画像(営業カレンダー)]
[画像入力2: 顧客の限定メニュー写真]

Image 1の桜モチーフの配色・装飾、カレンダーのグリッドレイアウトを完全に踏襲したまま、新しい営業カレンダー画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(おすすめメニュー・リーフ柄)]
[画像入力2〜5: 顧客写真(下記4箇所にそれぞれ対応)]

Image 1のリーフ柄の装飾、配色、レイアウトを完全に踏襲したまま、新しいメニュー画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(春の感謝祭セール・桜柄)]
[画像入力2〜5: 顧客写真(下記4箇所にそれぞれ対応)]

Image 1の桜柄の装飾、ピンク基調の配色、レイアウトを完全に踏襲したまま、新しいセール画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(単品広告・黒背景)]
[画像入力2: 顧客写真]

Image 1の黒背景に金の差し色を効かせた配色、レイアウト、フォントの雰囲気を完全に踏襲したまま、新しい単品広告画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(MIX SMOOTHIE単品訴求)]
[画像入力2: 顧客の商品写真(スムージーのカップ)]
[画像入力3: ブランドロゴ画像(use_logo_imageがtrueの場合のみ)]

Image 1の水しぶき・フルーツを散らした構成、配色、手描き風の飾り文字のスタイルを完全に踏襲したまま、新しい訴求画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(ごろっとフルーツスムージー・3種展開)]
[画像入力2〜4: 顧客の商品写真(3種、左から順に対応)]

Image 1のフルーツを散らした構成、配色、手描き風の飾り文字のスタイルを完全に踏襲したまま、新しい訴求画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(ローストベジフォカッチャ・英語ポスター)]
[画像入力2: 顧客の商品写真]

Image 1の大きな見出し文字と写真を組み合わせたレイアウト、配色、フォントの雰囲気を完全に踏襲したまま、新しいポスター画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(具材ラベル付きサンドイッチ図解)]
[画像入力2: 顧客の商品写真(断面がわかるアングル)]

Image 1の背景色、引き出し線のスタイル、太字ゴシック体の見出しを完全に踏襲したまま、新しい図解画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(苺みるくかき氷)]
[画像入力2: 顧客の商品写真]

Image 1の和柄装飾、配色、毛筆体+スクリプト体を組み合わせたフォントスタイルを完全に踏襲したまま、新しいスイーツ訴求画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(ストロベリーピスタチオクレープ)]
[画像入力2: 顧客の商品写真]

Image 1の紺色背景、上品なセリフ体の大見出し、スクリプト体のサブタイトルというスタイルを完全に踏襲したまま、新しい訴求画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(ベーカリーOPEN告知・イラスト版)]

Image 1の手描き風イラストのタッチ、パステルカラーの配色、装飾フレームのスタイルを完全に踏襲したまま、新しいOPEN告知画像を1枚生成してください(このテンプレートは実写を使わず、Image 1と同じイラストタッチで構成してください)。今回の業種は「{business_genre}」です。
...
```
[画像入力1: 参考デザイン画像(NEW OPEN 690円均一キャンペーン)]
[画像入力2〜4: 顧客写真(3品、左から順に対応)]

Image 1の濃紺×黄緑の配色、筆文字風の大きな数字表現、レイアウトを完全に踏襲したまま、新しいキャンペーン画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(週末ブランチ・選べるプレート)]
[画像入力2〜4: 顧客写真(3品、左から順に対応)]

Image 1のナチュラルな配色、罫線と余白を活かしたレイアウトを完全に踏襲したまま、新しいメニュー画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(炭火串焼きMENU)]
[画像入力2: 顧客写真(上部の串焼き集合写真)]
[画像入力3〜7: 顧客写真(5種の串写真、それぞれ下記の品目に対応)]
[画像入力8: 顧客写真(鶏だし茶漬け)]
[画像入力9: 顧客写真(焼きおにぎり)]

Image 1の和風の配色・装飾、左上のロゴマーク、リスト形式のレイアウトを完全に踏襲したまま、新しいメニュー画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(選べる彩りボウル)]
[画像入力2〜5: 顧客写真(4品、下記の位置にそれぞれ対応)]

Image 1のカラフルな4分割レイアウト、各コーナーの色タグ、中央バナーの構成を完全に踏襲したまま、新しいメニュー画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(鉄板ぎょうざメニュー)]
[画像入力2: 顧客写真(メインの鉄板ぎょうざ写真)]

Image 1の毛筆体の見出し、緑と紺を基調にした配色、ボックスで区切られたレイアウトを完全に踏襲したまま、新しいメニュー画像を1枚生成してください。
...
```
[画像入力1: 参考デザイン画像(炭火香るさば重)]
[画像入力2: 顧客の商品写真]

Image 1の水色系の背景、筆文字風のあしらい、左右に説明文を配置したレイアウトを完全に踏襲したまま、新しい訴求画像を1枚生成してください。
