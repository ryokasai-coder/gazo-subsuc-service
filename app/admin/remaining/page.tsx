    ...
    <div className="min-h-screen bg-[#F8F8FA]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        <div className="bg-white rounded-2xl p-4 mb-5 flex items-center gap-4 shadow-sm">
          <div className="w-10 h-10 bg-[#FFF0F6] rounded-full flex items-center justify-center flex-shrink-0">
          ...
          <div>
            ...
            <p className="text-xs text-[#6B7280] mt-0.5">ペース通りの依頼数：<strong className="text-[#E85C97]">{expectedCount}回 / 10回</strong></p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-3xl shadow-sm overflow-hidden">
            <table className="w-full text-sm">
              <thead className="bg-[#F8F8FA] border-b border-[#EFEFEF]">
                <tr>
                  <th className="text-left px-4 py-3 text-xs font-semibold text-[#6B7280]">会社名</th>
                  <th className="text-left px-4 py-3 text-xs font-semibold text-[#6B7280]">依頼数</th>
                  <th className="text-left px-4 py-3 text-xs font-semibold text-[#6B7280]">進捗</th>
                  <th className="text-left px-4 py-3 text-xs font-semibold text-[#6B7280]">ステータス</th>
                </tr>
              </thead>
                    ...
                    <tr key={u.user_id} className="hover:bg-[#FAFAFA] transition-colors">
                      ...
                      <td className="px-4 py-3 w-44">
                        <div className="w-32 bg-[#F8F8FA] rounded-full h-2">
                          <div
                            className="bg-[#E85C97] h-2 rounded-full transition-all"
